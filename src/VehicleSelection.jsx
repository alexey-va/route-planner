...
function VehicleSelection({vehiclesConfig, weight, vehicle, setVehicle}) {
    return (
        <div className="mx-2 flex flex-row gap-12 max-sm:gap-4 mt-2 pb-3">
            {/* VEHICLE SELECTION */}
                    ...
                    <div key={key} className="flex flex-col space-y-2">
                        <div className="flex items-center space-x-1">
                            ...
                            <label
                                ...
                                {vehicle !== 0 && key == 1 ? <span className={`text-nowrap absolute pl-2 self-center translate-y-5 -translate-x-7 text-[0.7rem] text-red-600`}>Рассчитайте дистанцию вручную</span> : ""}
                            </label>
